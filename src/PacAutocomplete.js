/**
 * Initializes a Google Places Autocomplete widget.
 ...
 * This class provides a Google Places Autocomplete widget.
 */
export class PacAutocomplete {
  ...
  constructor(config) {
    ...
    this.#options = {
      ...
      onError: (error) => console.error("PAC Error:", error),
    ...
    //console.log("PacAutocomplete options:", this.#options.classes);

    this.#onDataCallback = this.#options.onData;
